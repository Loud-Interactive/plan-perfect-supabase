 ...
 */
function parseMarkdownToJson(markdown: string): JsonOutput {
  ...
  let currentSubsection: SubsectionStructure | null = null
...
serve(async (req) => {
  ...
  try {
    ...
    const jsonOutput = parseMarkdownToJson(taskData.unedited_content)
