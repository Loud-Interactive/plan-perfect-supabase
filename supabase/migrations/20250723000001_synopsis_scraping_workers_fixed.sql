-- Synopsis Perfect Parallel Scraping - Worker Management Tables (Fixed)
...
-- Function to get current scraping status (FIXED - no FILTER clause)
...
BEGIN
  ...
  WITH worker_stats AS (
    SELECT 
      ...
      COUNT(CASE WHEN status = 'scraping' THEN 1 END) AS active_workers,
