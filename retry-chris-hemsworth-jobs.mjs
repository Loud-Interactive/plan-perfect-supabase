...
/**
 * Retry Chris Hemsworth outline generation jobs (slow mode)
 * Usage: SUPABASE_SERVICE_ROLE_KEY=your_key node retry-chris-hemsworth-jobs.mjs
 */
...
if (!SUPABASE_SERVICE_KEY) {
  ...
  console.error('Usage: SUPABASE_SERVICE_ROLE_KEY=your_key node retry-chris-hemsworth-jobs.mjs');
  process.exit(1);
}
...
const jobsToRetry = [
  ...
  },
  {
    ...
    current_status: "generating_outline"
  },
  {
